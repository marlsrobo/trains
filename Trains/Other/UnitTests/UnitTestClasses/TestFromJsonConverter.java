...
public class TestFromJsonConverter {
    ...
    public void init() {
        ...
        Destination lincolnWashington = new Destination(
            new UnorderedPair<ICity>(lincoln, washington));
        ...
        IPlayerData playerData = new PlayerData(
            new TrainsPlayerHand(TestTrainsReferee.TenCardDeckSupplier()),
    ...
    public void testFromJsonToUnvalidatedSetOfDestinationsValidJson() {
        ...
        assertEquals(expected,
            FromJsonConverter.fromJsonToUnvalidatedSetOfDestinations(jsonDestinations));
    }
    ...
    public void testFromJsonToUnvalidatedDestinationValidJson() {
        ...
        assertEquals(destination1,
            FromJsonConverter.fromJsonToUnvalidatedDestination(destination1Json));
    }
    ...
    public void testGetRailConnectionsFromJsonValidJson() {
        ...
        assertTrue(this.rails
            .containsAll(FromJsonConverter.getRailConnectionsFromJson(jsonConnections, citiesMap)));
        assertTrue(FromJsonConverter.getRailConnectionsFromJson(jsonConnections, citiesMap)
            .containsAll(this.rails));
        assertEquals(this.rails.size(),
            FromJsonConverter.getRailConnectionsFromJson(jsonConnections, citiesMap).size());
    }
    ...
    public void testParseConnectionsFromCityValidJson() {
        ...
        assertEquals(expected,
            FromJsonConverter.parseConnectionsForPairOfCities(segment, endpoints));
    }
    ...
    public void testPlayerStateFromJsonValidJson() {
        ...
        assertTrue(samePlayerGameState(this.gameState,
            FromJsonConverter.playerStateFromJson(jsonPlayerState, this.map)));
    }
    ...
    private boolean samePlayerGameState(IPlayerGameState gameState1, IPlayerGameState gameState2) {
        ...
        boolean sameDestinations = gameState1.getDestinations()
            .equals(gameState2.getDestinations());
        boolean sameRails = gameState1.getNumRails() == gameState2.getNumRails();
        boolean sameOwnedConnections = gameState1.getOwnedConnections()
            .equals(gameState2.getOwnedConnections());
        boolean sameOpponentInfo = gameState1.getOpponentInfo()
            .equals(gameState2.getOpponentInfo());
        return sameCards && sameDestinations && sameRails && sameOwnedConnections
            && sameOpponentInfo;
    }
    ...
    public void testSelectedDestinationsFromPlayerStateValidJson() {
        ...
        assertEquals(destinations,
            FromJsonConverter.selectedDestinationsFromPlayerState(jsonPlayerData, this.map));
    }
    ...
    public void testConvertDestinationNamesToDestinationsInvalid() {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> FromJsonConverter
                .convertDestinationNamesToDestinations(destinationNames, this.map));
    }
    ...
    public void testConvertDestinationNamesToDestinationInValid() {
        ...
        assertThrows(IllegalArgumentException.class,
            () -> FromJsonConverter
                .convertDestinationNamesToDestination(destinationNames, this.map));
    }
    ...
    public void testOccupiedConnectionsFromJsonValid() {
        ...
        assertEquals(expected,
            FromJsonConverter.occupiedConnectionsFromJson(
                ToJsonConverter.playerGameStateToJson(this.gameState)));
    }
    ...
    public void testOccupiedConnectionForPlayerValid() {
        ...
        assertEquals(opponent1Connections,
            FromJsonConverter.occupiedConnectionsForPlayer(opponent1));
    }
    ...
    @Test
    public void testMapNoWidth() {
        JsonObject jsonMap = ToJsonConverter.mapToJson(this.map);

        jsonMap.remove("width");

        assertThrows(IllegalArgumentException.class,
            () -> FromJsonConverter.trainMapFromJson(jsonMap));
    }

    @Test
    public void testMapWidthZero() {
        JsonObject jsonMap = ToJsonConverter.mapToJson(this.map);

        jsonMap.add("width", new JsonPrimitive(0));
    ...
    @Test
    public void testMapNoTarget() {
        JsonObject jsonMap = ToJsonConverter.mapToJson(this.map);

        jsonMap.getAsJsonObject("connections").add("Chicago", new JsonPrimitive(""));
    ...
    @Test
    public void testMapNoConnections() {
        JsonObject jsonMap = ToJsonConverter.mapToJson(this.map);

        jsonMap.add("connections", new JsonPrimitive(""));
